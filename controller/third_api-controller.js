...
router.get("/api/tenShows/", async (req, res) => {
  try {
    const secondData = await axios.get("https://api.themoviedb.org/3/trending/tv/day?api_key=68c0e41b28df67801658d2f261ee4403", {
...
router.get("/api/tenMovies/", async (req, res) => {
  try {
    const secondData = await axios.get("https://api.themoviedb.org/3/trending/movie/day?api_key=68c0e41b28df67801658d2f261ee4403", {
